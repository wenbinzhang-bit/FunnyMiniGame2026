...
namespace FIMSpace.FProceduralAnimation
{
    public static partial class RagdollHandlerEditor
    {
        ...
        {
            if( handler == null ) { UnityEngine.Debug.Log( "[Ragdoll Animator 2] No Ragdoll Handler to export settings!" ); return; }

            var preAnimMode = handler.AnimatingMode;
            handler.AnimatingMode = RagdollHandler.EAnimatingMode.Falling;
            ...
            handler.AnimatingMode = preAnimMode;
        }
